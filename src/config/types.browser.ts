...
export type BrowserConfig = {
  ...
  /** Minimum timeout (ms) for browser action requests (navigate, click, screenshot, etc.). When set, overrides the default 20s per-action timeout. Useful for remote CDP endpoints with higher latency. */
